...
This module introduces the Matomo page Tracking on all the website pages.
...
To use this module, activate the Matomo Analytics in settings or configuration for each website:
