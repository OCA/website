...
Remove portal email footer signature
====================================

This module remove footer signature from emails, when portal addon is installed.This addon is autoinstalled with the mail remove footer signature module
...
* go to ...
 ...
 repo_id is available in https://github.com/Antiun/antiun-odoo-addons/tree/8.0/mail_portal_remove_footer_signature
 branch is "8.0" 
