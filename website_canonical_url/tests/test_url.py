...
class URLCase(SavepointCase):
    ...
    def test_canonical_domain_default(self):
        self.assertEqual(self.website._get_canonical_domain(), self.base_url)

    def test_canonical_domain_custom(self):
        self.website.canonical_domain = "https://oh.yeah"
        self.assertEqual(self.website._get_canonical_domain(), "https://oh.yeah")
    ...
    def test_canonical_relative_url_nolang(self):
        ...
        self.assertEqual(
            self.website._get_canonical_relative_url(req=req), "/my/lovely/page"
        )

    def test_canonical_relative_url_nolang_no_match(self):
        # no lang in path and lang is not the default one
        req = FakeRequest(self.website, "/my/lovely/page?foo=baz", lang="it_IT")
        self.assertEqual(
            self.website._get_canonical_relative_url(req=req), "/it_IT/my/lovely/page"
        )

    def test_canonical_relative_url_default_lang_match(self):
        req = FakeRequest(self.website, "/it_IT/my/lovely/page?foo=baz", lang="it_IT")
    ...
    def test_canonical_relative_url_default_lang_no_match(self):
        ...
        self.website.default_lang_id = self.env.ref("base.lang_it")
        self.assertEqual(
            self.website._get_canonical_relative_url(req=req), "/en_US/my/lovely/page"
        )
    ...
    def test_canonical_relative_url_home_special_case(self):
        ...
        self.website.default_lang_id = self.env.ref("base.lang_it")
        self.assertEqual(self.website._get_canonical_relative_url(req=req), "/")
    ...
    def test_canonical_relative_url_home_special_case_lang_no_match(self):
        ...
        self.website.default_lang_id = self.env.ref("base.lang_it")
        self.assertEqual(self.website._get_canonical_relative_url(req=req), "/en_US/")

    def test_canonical_url(self):
        self.website.canonical_domain = "https://oh.yeah"
        req = FakeRequest(self.website, "/page/foo?foo=baz")
        self.assertEqual(
            self.website.get_canonical_url(req=req), "https://oh.yeah/page/foo"
        )
    ...
    def test_canonical_url_home_special_case(self):
        ...
        self.website.canonical_domain = "https://oh.yeah"
        req = FakeRequest(self.website, "/page/homepage?foo=baz")
        self.assertEqual(self.website.get_canonical_url(req=req), "https://oh.yeah/")
    ...
    def test_canonical_url_home_special_case_no_match(self):
        ...
        req = FakeRequest(self.website, "/page/homepage?foo=baz", lang="it_IT")
        self.assertEqual(
            self.website.get_canonical_url(req=req), "https://oh.yeah/it_IT/"
        )
