...
odoo.define("website_base_multi_image.images", function(require){
    "use strict";
    ...
    animation.Class.extend({
        ...
        bind_events: function () {
            this.$el.on("change", "#file_input", $.proxy(this.image_preview, this));
            this.$el.on("click", ".remove-image", $.proxy(this.image_remove, this));
            this.$el.on("click", ".make-main-image", $.proxy(this.image_make_main, this));
        },
