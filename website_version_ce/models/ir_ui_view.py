...
class View(models.Model):
    ...
    def get_inheriting_views_arch(self, view_id, model):
        ...
        for k in keys:
            ...
            elif context_version_id and k.version_id.id is False \
                    and k.website_id.id and k.website_id.id == context_website_id:
            ...
            elif not context_version_id and k.version_id.id is False \
                    and k.website_id.id and k.website_id.id == context_website_id:
                right_ids[k.key] = k.id
                priority[k.key] = 2
