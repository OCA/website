...
class BaseConfigSettings(models.TransientModel):
    ...
    def set_analytics(self, ids):
        ...
        params.set_param('google_management_client_id', myself.ga_client_id or
                         '', groups=['base.group_system'])
        params.set_param('google_management_client_secret',
                         myself.ga_client_secret or '',
                         groups=['base.group_system'])

    @api.model
    def get_analytics(self, ids):
        params = self.env.get('ir.config_parameter')
        ga_client_id = params.get_param('google_management_client_id',
                                        default='')
        ga_client_secret = params.get_param('google_management_client_secret',
                                            default='')
        return dict(ga_client_id=ga_client_id,
