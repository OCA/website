odoo.define("website_sale_stock.VariantMix", function (require) {
  "use strict";
  ...
  VariantMixin._onChangeCombinationStock = function (ev, $parent, combination) {
    ...
    var xml_load = $.when(
      parent_xml,
      ajax.loadXML(
        "/nitrokey_website_sale_stock/static/src/xml/website_sale_stock.xml",
        QWeb
      )
    );
    xml_load.then(function () {
      ...
      const $custom_message = $(
        QWeb.render("nitrokey_website_sale_stock.product_availability", combination)
      );
