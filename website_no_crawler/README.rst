...
By default, /robots.txt on an Odoo installation with de website module installed will allow indexing by webcrawlers.

This module will overwrite view that generates /robots.txt and will disalow indexing.
