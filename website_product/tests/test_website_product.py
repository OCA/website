...
class TestController(SavepointCase):
    ...
    def test_compute_website_url(self):
        self.assertTrue("/catalog/product/" in self.product_test.website_product_url)

    @patch("odoo.addons.website_product." "controllers.main.request")
    ...
    def test_website_product_publish_button(self):
        ...
        self.assertTrue(product_page["url"], self.product_test.website_product_url)

    def test_website_product_publish_button_not_allowed(self):
        with self.assertRaises(exceptions.AccessError):
            self.product_test.with_user(self.demo_user).website_product_publish_button()
