...
odoo.define('website_field_autocomplete.field_autocomplete', function (require) {
    ...
    snippet_animation.registry.field_autocomplete =
        ...
        */
            autocomplete: function (request, response) {
                ...
                return $.ajax({
                    ...
                    var data = records.reduce(function (a, b) {
                        a.push(
                            {
                                label: b[self.displayField],
                                value: b[self.valueField],
                            }
                        );
                        return a;
                    }, []);
            ...
            start: function () {
                ...
                this.displayField = this.$target
                    .data('display-field') || this.queryField;
                this.valueField = this.$target
                    .data('value-field') || this.displayField;
