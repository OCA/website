...
const countryCodeDropdown = animation.registry.CountryDropdown;

animation.registry.CountryPhoneCodeDropdown = animation.Class.extend({
    ...
    start: function () {
        ...
        this.$btn_country_phone_code = this.$target.find(".js_btn_country_phone_code");
        ...
        this.$dropdown_list.on("scroll", debounce(this.lazy_image_load.bind(this), 35));
